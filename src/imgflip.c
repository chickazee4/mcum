...
char *imgflip_ids[] = { KERMIT_TEA, CONDESCENDING_WONKA, GRUMPY_CAT, BIKER_GUY, NUCLEAR_FAMILY, JOHN_WAYNE_1, JOHN_WAYNE_2, MOTORCYCLE, YOUNG_SAM_ELLIOTT, OLD_SAM_ELLIOTT_1, OLD_SAM_ELLIOTT_2, PUNISHER, CHUNKY_FARMER, MINIONS_1, MINIONS_2, RONALD_REAGAN_1, RONALD_REAGAN_2, FLAMING_SKULL, KNITTING, CLINT_EASTWOOD_1, CLINT_EASTWOOD_2, CLINT_EASTWOOD_3, ELVIS };
